...
class addDetails(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        url = "https://82rlitwo02.execute-api.us-east-2.amazonaws.com/DapipersonDetails?personName="+str(person_name_value)+"&personLocation="+str(person_location_value)+"&Temparature="+str(temparature_value)
        response = requests.get(url)
